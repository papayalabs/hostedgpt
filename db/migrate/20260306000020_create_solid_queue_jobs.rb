class CreateSolidQueueJobs < ActiveRecord::Migration[8.0]
  def change
    # solid_queue_jobs — core jobs table; must exist before all execution tables
    ...
    add_index "solid_queue_pauses", ["queue_name"],
              name: "index_solid_queue_pauses_on_queue_name", unique: true
    ...
    # solid_queue_processes — worker/dispatcher process registry
    ...
    # solid_queue_blocked_executions — jobs waiting on a concurrency lock
    ...
    # solid_queue_claimed_executions — jobs currently being worked
    ...
    # solid_queue_failed_executions — jobs that raised an error
    ...
    # solid_queue_ready_executions — jobs queued and ready to run
    ...
    # solid_queue_scheduled_executions — jobs waiting for a future scheduled_at
    ...
    # solid_queue_recurring_executions — deduplication log for recurring tasks
    ...
    # solid_queue_recurring_tasks — static/dynamic cron task definitions
