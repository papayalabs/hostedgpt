class APIService < ApplicationRecord
  ...
  enum :driver, %w[openai anthropic google].index_by(&:to_sym)
  ...
  def requires_token?
    [URL_OPEN_AI, URL_ANTHROPIC, URL_GOOGLE].include?(url) # other services may require it but we don't always know
  end
