module Agent
  class Message < ApplicationRecord
    include Agent::Message::DocumentImage, Agent::Message::Version, Agent::Message::Cancellable, Agent::Message::Toolable

    belongs_to :assistant
    belongs_to :conversation, inverse_of: :messages
    belongs_to :content_document, class_name: "Agent::Document", inverse_of: :message, optional: true
    belongs_to :run, optional: true
    has_one :latest_assistant_message_for, class_name: "Agent::Conversation", inverse_of: :last_assistant_message, dependent: :nullify

    include Agent::Message::Billable
