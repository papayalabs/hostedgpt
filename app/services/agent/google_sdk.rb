module Agent
  class GoogleSDK < SDK
    ...
    def self.reauthenticate_credential(credential)
      ...
      begin
        response = Agent::SDK::Post.new(url: "https://oauth2.googleapis.com/token").www_content.param(
          client_id: Agent::Setting.google_auth_client_id,
          client_secret: Agent::Setting.google_auth_client_secret,
