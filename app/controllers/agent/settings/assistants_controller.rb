module Agent
  module Settings
    class AssistantsController < Agent::Settings::ApplicationController
      ...
      def create
        @assistant = Agent::Current.user.assistants.new(assistant_params)
      ...
      def destroy
        if Agent::Current.user.assistants.count > 1 && @assistant.deleted!
