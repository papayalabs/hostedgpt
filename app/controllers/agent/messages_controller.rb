module Agent
  class MessagesController < Agent::ApplicationController
    ...
    def set_message
      @message = Agent::Message.find(params[:id])
      redirect_to root_url, status: :unauthorized if @message.conversation.user != Agent::Current.user
    end
